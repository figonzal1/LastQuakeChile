...
fun coordinateToDMS(context: Context, coordinates: Coordinate): String {
    ...
    val dmsLat = String.format(
        ...
        if (coordinates.latitude < 0) context.getString(R.string.south_cords) else context.getString(
            R.string.north_cords
        )
    )
    ...
    val dmsLong = String.format(
        ...
        if (coordinates.longitude < 0) context.getString(R.string.west_cords) else context.getString(
            R.string.east_cords
        )
    )
