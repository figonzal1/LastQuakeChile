...
public class FbShareTest {
	...
	@Test
	public void test_click_fb_button() {
		click_first_item();
	...
	private void check_and_click_fb() {
		...
		buttonFB.check(matches(allOf(isDisplayed(), isClickable())));
		...
		/*onView(withId(R.id.fab_fb)).perform(click());

		//Checkear que intent tenga paquete de wsp
		intended(toPackage(mContext.getString(R.string.PACKAGE_NAME_FB)));
